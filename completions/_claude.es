...
_claude() {
  ...
  main_options=(
    ...
    '--agent[Agente para la sesión actual. Anula la configuración '\''agent'\'']:agent:'
...
_claude_agents() {
  _arguments \
    ...
    '--agent[Agente predeterminado para sesiones despachadas desde la vista de agentes]:agent:' \
    ...
    '--model[Modelo predeterminado para sesiones despachadas desde la vista de agentes]:model:' \
